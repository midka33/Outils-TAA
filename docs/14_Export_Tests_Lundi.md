...
**Contrôle anti-régression BUG-EXPORT-018 :** la simple sélection du dossier ne doit déclencher aucune exception `NameError` ou `AttributeError`. Le nombre de carnets publiables doit être calculé à partir du dossier sélectionné et de ses sous-dossiers.
...
**Contrôle anti-régression BUG-EXPORT-018 :** la résolution du dossier doit inclure les carnets des sous-dossiers et conserver l'ordre courant des carnets.
